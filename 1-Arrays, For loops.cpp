...
//if time remains, have the students add st, nd, rd or th to the end of the required number, (1st, 2nd, 3rd.....)
...
//REQURIED LESSON- we spent roughly 10-15 minutes explaining the difference in cin, and getline.
//If you switch from cin to getline you must add cin.ignore(). But you can use cin repeatedly without it, and also getline with using it.
//It's only required when you go from cin to getline. It is not needed going from getline to cin.
